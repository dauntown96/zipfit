...
| 날짜 | 내용 |
|---|---|
| 2026-09-26 | **B35 — 의성 7월 `19d71761` 두 키 반영 + 군산나운4 영구임대 입주자격완화 새 회차 `…020822`(공고 9/23 · 접수 10/6) 원문 분석·반영, `완료(보조 누락)`**(🔴 **자격 `verification_requirements` UPDATE 1(`19d71761`) · `housing_units` INSERT 2 · `eligibility_criteria` INSERT 2 · `announcement_policies` INSERT 29(9/18 `…020801` 행 13개 바이트 재사용 + 새 16) · `announcements.relaxation_detail` UPDATE 1(NULL이던 칸) · `announcement_analysis` INSERT 1 · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 0 · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 analysis v9.1 · reverify v4.8을 착수 전에 다시 불러왔다. ① ✅ **의성 `19d71761`**(항목 0 · 판정 (가) 7월 PDF 한 겹) — `배점기준_경북의성29A-1형(…)` 안 `장애정도` → 「장애의 정도가 심한 장애인 : 3점 / 장애의 정도가 심하지 않은 장애인 : 1점」 · `사회취약계층` → 7월 PDF p.7(인쇄 13) ③ 행 원문 두 조각을 ` / `로. BEFORE `88019d98…` → AFTER `14680e47…` · 객체 키 4 · 최상위 키 11 불변. ② ✅ **9/23 ≠ 9/18 정정**(멈춤 조건 아님) — 9/18은 26형 402~408동 예비자 500 · 배점 100점(거주기간·연령·세대원수·가점)이고, 9/23은 406동 **26.37A 청년/대학생 · 26.37B 주거약자**, 임대조건·배점표·선정순서·일정이 다르다. ③ ✅ **형별 공급계획 칸 확정**(hwpx `cellAddr`) — 건설 세대수 15·14 · 현재 공가 7·6 · **금회 모집 예비자 10·10 = 20**(B23 요지의 「15·14」는 건설 세대수였다). `recruit_count` 합 20 = 원문 형별 합(총계 행 없음). ④ ✅ **B형 주거약자 배점표** — hwpx 셀과 PDF p.10 둘 다 두 행(3점 「장애정도가 심한 장애인」 · 1점 「…심하지 않은 장애인」), 빈칸 「-」 행이 없어 밀림 없음. ⑤ ✅ **카드 합치기** — 두 회차 원문에 같은 문장 13행은 9/18 행을 바이트 그대로 복사했다(그룹 정책 52행 → 화면 39행). 달라진 문장은 새 행(공고일·A/B 자격·임대조건·일반공급 순위·배점표 A/B·일정·발표·⚠️ 쪽 번호 p.12→p.14 · p.34→p.35)으로 두었고, 9/18 행이 빠뜨린 원문 문장 5묶음(계약안내 등기우편 · 유의사항 신청자격·공급일정·신청서류·입주대상자 결정)을 같은 category 보충 행으로 더했다. ⑥ ✅ **완화** — `is_relaxed_recruitment` true · `contract_before_verification` false(불변식 5) · 자격 2행 `income_limit_exempt`·`asset_limit_exempt` true · `income_pct` NULL · `car_limit` 4,542만원 · `relaxation_detail`은 완화 표 4줄만(재계약 모순은 ⚠️ 정책 행 한 곳). ⑦ ✅ **전환 관문 재료 없음**(임대조건 표에 전환 열 없음 — `extra_note`에 문장 없음) · `extra_note`는 원문 표 값과 가군/나군 이원화 원인만. ⑧ ✅ **검증** — 한 트랜잭션 안 가드 18개(행별 md5 · 새 정책 md5 집합 · jsonb canonical md5 · NFC · 불변식 1·2·3·4·5·6·7·9) 통과, 사후 불변식 10 = 0 · 형제 6 ID 산물 md5 전·후 불변 · 블록 `1096a54c…`·그룹 `be65f77f…` 불변. ⑨ 🅑 **분석률** 접수 전 **76/40 → 76/41**(17:58:23Z → 18:03:18Z, +1 = `…020822`) · 접수 중 7/1 불변 |
| 2026-09-26 | **B38 — B37 잔여 3건: 음성 29B 계약면적 ⚠️ 신규 · 양산 7월 형제 2행 · 의성 7월 장애정도(멈춤)**(🔴 **정책 INSERT 1(음성 `…020698` `bcf8d93d`) · 세대 `extra_note` UPDATE 2 · 자격 0 · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 0 · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 reverify v4.7 · analysis v9.0을 착수 전에 다시 불러왔다. ① ✅ **음성금석A2 29B 세대당 계약면적 ⚠️**(항목 1) — 두 겹 일치: hwpx 셀(29B 행 col2~5 = 29.23 · 13.4732 · 2.7069 · 14.9438, 단지명 셀 「음성금석A2」가 그 행을 덮음) + PDF p.3(인쇄 「- 3 -」) 같은 줄이 각 열 머리 x 구간 아래. category 「⚠️ 세대당 계약면적」 · 셋째 줄 「p.3 「2. 모집대상 주택」 음성금석A2 29B: 세대당 계약면적(㎡) 주거 전용 29.23 / 주거 공용 13.4732 / 기타 공용 2.7069 / 합계 14.9438」 · 계산 결과 미기재 · NFC · md5 `56955fb0…`. 음성 정책 16 → **17** · 기존 16행 md5 불변. `c956e127`는 원문 값 그대로 둠. ② ✅ **양산 7월 형제**(항목 2) — `38f20a95` → 「복도식/개별난방. 최초입주 2009.06. 전용면적 39.43㎡ / 39.72㎡ / 39.82㎡. 대기중인 예비자수 37명.」(`067de61b…`) · `c5e4a516` → 「복도식/개별난방. 대기중인 예비자수 34명.」(`29b7cf25…`). 값은 7월 원문 p.3 단지 개요·모집대상 표와 대조(39㎡는 원문에 면적 행이 셋). ③ ⏸ **의성 `19d71761` 멈춤**(항목 3) — 7/15 원문은 PDF만 있고 hwpx가 Drive 전역에 없다(두 겹 중 한 겹 부재). PDF p.7 왼쪽 단(인쇄 13) 「■ 배점기준(주거약자용 주택) : 경북의성 29A-1형」 「④ 장애정도」 줄은 결측이 아니며 3점 「장애의 정도가 심한 장애인」(x 235–281 / 머리 252–264) · 2점 「-」(313–316 / 309–321) · 1점 「…심하지 않은 장애인」(345–400 / 367–379). 행 미접촉(`88019d98…`). ④ ✅ **검증** — 대상 3그룹(음성 · 양산 `…020817` · 의성 `…020709`)의 블록·그룹 ID·행 수·대상 밖 행 md5가 착수 스냅샷과 같음 · 불변식 1·6·7·9·10 = 0 · NFC 위반 0 |
| 2026-09-26 | **B37 — B36 확인서 반영 + 접수 9/28~30 활성 공고 주거약자 배점 장애정도 칸 전수 + ⚠️·해설 키 정리**(🔴 **세대 `extra_note` UPDATE 12 · 정책 UPDATE 6 · 자격 `verification_requirements` UPDATE 11 · INSERT 0 · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 0 · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 reverify v4.7 · analysis v9.0을 착수 전에 다시 불러왔다. 행마다 BEFORE md5 가드 + AFTER md5 상수 대조로 1행씩 걸었고 전부 적중했다. ① ✅ **`extra_note` 5칸**(항목 1) — 음성삼성 51 `1898d2f9` · 음성금왕3-1 59 `960ffebd` · 창녕 36 `aa85d6d3` · 양산 46㎡ `b5601865`(전환 조각 → 최대전환시 표 값) · 창녕 46 `74442885`(1-b — 「같은 46형에 전용면적이 둘이다」까지 걷어 `12782b2b…`). ② ✅ **원주 `27c304e0` ④ 장애정도 칸**(항목 2, `e2cf7671…`) · **미성년자녀수 ⚠️ 3행**(항목 3 — 군산 `2073b9de` `e3ac940d…` · 장성 `8b18b89d` · 담양 `7a99fb39` `1a3b7d3d…`, category 「⚠️ 배점기준 ③ 미성년자녀수 표기 주의」). ③ ✅ **주거약자 배점 장애정도 칸 전수**(항목 4 — 사전 승인 조건부) — `apply_end ≥ 2026-09-28` 대표 104건의 그룹 전체에서 뽑아 **정책 2 · 자격 7**을 반영했다(요청서 표 6 + 새로 찾은 보성운곡 정책 `bcf4dfb0` · 의성 `6b5dbc75` · 아산 `0ca4187e`). 원문 7종 전부 두 겹 일치(hwpx 셀 3점 「심한」·2점 「-」·1점 「심하지 않은」 + PDF 점수 머리 x 구간). 의성 7월 회차 `19d71761`(점수 없이 우리 메모뿐)은 **멈춤**. 반영 뒤 활성 그룹에 「심한 장애인 2점」 0 · 「장애정도 / - / 심한」 0. ④ ✅ **자격 키 삭제** — 담양 `dd699416` · 장성 `9060f0ec` · `f836df2a`의 「⚠️ 미성년자녀수 배점의 출생 기준일 표기 주의」(항목 5, 키 수 −1) · 창녕 `8d0a4320` 「정정공고」·「주거약자용_주택」(항목 6, 22 → 20 · 원문 문장은 정책 `2b4b603d`). 전역 ⚠️에서 「2007.09.16」 인용 0. ⑤ ✅ **음성 그룹 형제**(항목 7) — 연결 문장 5행을 「전용면적 A㎡(…) / B㎡(…)」로(값은 원문 p.3–4 표 줄과 대조) · 29B `c956e127` 해설 조각 삭제(사실은 `fde3c1fd`·`fae88d04`·`4e9fb942`) · 양산 7월 `4c70b436`(활성 `…020817` 카드가 그룹 경로로 읽음 → 반영). ⑥ ✅ **검증** — 대상 13그룹의 블록·그룹 ID·행 수·대상 밖 행 md5 전부 착수 스냅샷과 같음 · 불변식 1·6·7·9·10 = 0 · NFC 위반 0 · 같은 category 형제 md5 불일치 0 |
