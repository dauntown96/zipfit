...
| 2026-09-25 | **B34 — ⚠️ 주의 행·해설 문장 정리 반영(음성 `…020698` · 보성 `…020667` · 창녕 `…020816` · 양산대석 `…020754` · 원주 7/15 `…020352`)**(🔴 **정책 UPDATE 18 · INSERT 3 · DELETE 2 · DDL 0 · 함수 0 · EF 0 · 코드 0 · Drive 0 · Notion 0** · `[zipfit-backup]` 접촉 0). 확인서대로 5공고를 한 트랜잭션으로 반영했다. 행마다 BEFORE md5 · AFTER md5 · 공고별 행 수 · NFC를 가드로 걸었다. ① ✅ **⚠️ 판정 한 규칙**(확인서 1) — 「어긋남의 존재」는 사실 한 문장으로 허용하고 계산식·결과 금액·「검산 통과」는 불허한다. 음성 `554c3344` · 보성 `946bbf7d`(쪽 번호 p.10 → **p.9**) · 창녕 `50d6630a`(**안 B** — 삭제 대신 음성과 같은 꼴로 교체, `d96a0133…`)는 허용 문장만 남겼다. 양산 `d3f86039`(머리칸 「(150)」이 무엇의 수인지 원문이 밝히지 않음)는 **삭제**했다. ② ✅ **음성 `e7d3de79` 장애정도 칸 밀림 정정** — 원문은 3점 「심한 장애인」·2점 「-」(hwpx 셀 + PDF 좌표). 선정순서 도식은 신규 행으로 뗐다. ③ ✅ 창녕 `a09173d4` 쪼개기(교체 1 + 신규 「선정절차」·「서류제출 방법」) · `e2cfbd95`(우리 문장뿐인 정정 행) 삭제 · 양산 `aad365ed` 자리표시 번호 「000-000-0000」 글머리 삭제(규칙 11) · 원주 `9d3ac368` 할증표 평탄화 해제(활성 `…020783` `0a2fbfce`와 바이트 동일 → 카드에서 한 줄). ④ ✅ **행 수** 16 · 15 · 19 · 9 · 4(착수 15 · 15 · 18 · 10 · 4) · 앵커 재검: 교체·신규 전 줄이 에이전트 좌표 검사 통과 줄의 부분집합이다. 새로 쓴 창녕 ⚠️ 행은 p.4 표 셀·각주로 대조했다 · 불변식 1·6·7·9·10(그룹 전체) 0 · 형제 `…020783`·`…020407` 정책 md5 불변 · 블록 수 불변. ⑤ ⏭ **B36** — `extra_note`의 역산 문장 · 원주 `…020783` `27c304e0` 장애정도 칸 · `…020743`·`…020747`·`…020748` ⚠️ 행 |
