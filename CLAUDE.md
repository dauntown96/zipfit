...
| 2026-09-26 | **B43 — 9/29 접수 시작 단일 블록 4공고 분석·반영(천안쌍용5-2 공임50년 `…0756` · 부산만덕5 2블록 10년 분양전환 `0000061163` · 경남 일반 매입 `…0706` · 경기북부 일반 매입 `…0713`)**(🔴 **세대 INSERT 100(2·2·22·74) · 자격 INSERT 8(1·1·3·3) · 정책 INSERT 116(29·29·29·29) · `announcement_analysis` INSERT 4(전부 `완료(보조 누락)`) · `announcements` UPDATE 2(`…0756` `selection_method` 「우선순위추첨」 · `0000061163` `apply_start` 2026-09-29 — 원문 모집일정 표) · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 업로드 9(`fetch-attachment` `mode=upload`, `[임시]` 폴더 4) · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 analysis v9.1 · reverify v4.8을 착수 전에, analysis를 압축 뒤 첫 DB 쓰기 전에 다시 불러왔다. ① ✅ **천안 `…0756`** — 39형 전용 39.51·39.72 두 행에 모집 50을 `unit_group`/`group_recruit_count`로 · 증액 역산 6.0% 2/2 · 계약금 20% · 정책 29(12. 공통 유의사항 표 행 레이블 category). ② ✅ **부산만덕 `0000061163`** — 첨부는 hwpx 1건(PDF 없음 → hwpx 문단으로 앵커) · 소득·자산·청약저축 무관(`verification_flag_based`, 두 exempt true) · 원문 전환요율 「5%」·「3.5%」로 표 값 2/2 일치 · ⚠️ 1행(우체국 소인 기한: 주요일정 「10.15」 / Ⅳ 일정 표 「2026.03.18.」 / 제출방법 「10.13.~10.15.」) · 선정방법 「무작위추첨」은 허용값 3종 밖이라 `selection_method` NULL. ③ ✅ **경남 `…0706`** — 목록 xlsx 14,750B(운반 관문 통과) 22호 · 자격 3행(1순위 우선 · 1순위 장애인 70% · 2순위 100%, 자산 기준 원문 0회) · 전환 관문 「재료 없음」(무보증전환임대료 열만 있음). ④ ✅ **경기북부 `…0713`** — 목록 xlsx 20,303B 74호 · 템플릿 형제 경남과 정책 29행 중 20행 md5 같음, 9행은 공고일·일정·장소·50% 행 등 원문 차이. ⑤ ✅ **검증** — 공고마다 트랜잭션 안 불변식 1·2·3(행 수)·5·6·7·9·NFC 통과 · 세대·정책 md5 봉합(DB = 로컬) · 형제 구성원 산물 0 · 블록·그룹 md5 착수와 같음 · 🅑 접수 전 **76/41 → 76/45**(05:11:46Z → 05:43:11Z · 분자 +4 = 닫은 공고 4) · 접수 중 7/1 불변 |
