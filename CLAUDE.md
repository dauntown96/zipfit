...
| 날짜 | 내용 |
|---|---|
| 2026-09-26 | **B42 — 9/17 매입임대 템플릿 QnA 결과어 문항 마저(1-a 3종 · 1-b 훑기) + `…020822` 낡은 `pending_fields` 1줄**(🔴 **정책 INSERT 6 · `announcement_analysis` UPDATE 1 · UPDATE 0(정책·세대·자격) · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 0 · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 reverify v4.8 · analysis v9.1을 착수 전에 다시 불러왔다. ① ✅ **1-a 반영** — 신혼Ⅰ·Ⅱ Ⅰ-4(예비신혼부부 부모 주택 소유 · 「부적격자로 처리됩니다」) `…0776`·`…0777`·`…0774`·`…0784` 4행 `73706cda…` · 신혼Ⅰ 두 번째 「11」(계약체결 시까지 무주택세대구성원 · 「계약체결 및 입주가 불가합니다」, 충북 hwpx·광주 PDF 모두 번호 11이 두 번) `…0776`·`…0777` 2행 `a72047a0…`. 충북 QnA hwpx 바이트 · 광주 QnA PDF 정규화 일치(Ⅰ-4 질문은 번호 「4」가 둘째 줄 앞에 끼어 조각 대조 · 질문 셀 줄바꿈 「주택을 ⏎소유하신」은 한 줄로 이음) · 기존 행과 문장 겹침 0. category는 B41 행과 같은 주제 제목 꼴(문항 번호 없음). 정책 행 0776·0777·0774·0784 38·37·37·36 → **40·39·38·37**. ② ⏸ **1-a `…0776` Ⅳ-2 멈춤** — 결과어 문장(「반대의 경우(수급자 등 자격 탈락)는 …」)이 이미 `195bde88`에 있고 첫 ㅇ 문단만 없어 부분 겹침 → 교체 후보(`195bde88` `f3939bc7…` → `…0777` `1a3f9085`와 같은 바이트 `803dbd8b…`). ③ ✅ **1-b 훑기**(답변 문단 = hwpx 표 밖 문단 기준, 결과어 11종) — 새로 넣을 문항 0. 청년 Ⅰ-11(「제외」 표 안만) · Ⅰ-16/신혼 Ⅰ-14·Ⅰ-15(「기존 거주자 퇴거」) · 신혼 Ⅰ-1(세대구성원 범위 제외 · 목록이 표) · 신혼 Ⅱ-1(「예비신혼부부 제외」 예외 괄호) · 청년 Ⅳ-5(「불가피한」) · 신혼Ⅱ Ⅳ-5(B39 반영분) 제외. ④ ✅ **항목 2** — `…020822` `pending_fields` 4 → 3줄(첫 줄 「보조 자료: … 미확인」만 뺌). ⑤ ✅ **검증** — 7개 그룹 스냅샷(블록·그룹 ID·세대·자격·기존 정책·extras·analysis·공고 md5) 착수와 같음 · 불변식 1·6·9·10 = 0 · 7(군산 그룹) = 0 · 5 true/false · NFC 위반 0 · 형제 md5 같음 · 🅑 분석률 **76/41 · 7/1 불변**(04:31:34Z → 04:32:36Z) |
| 2026-09-26 | **B41 — B40·B39 멈춤분 승인 반영(7월 `20722_1` 세대 2행 · `…0778` 순위 이름 2 · `324608dd` 첫 줄) + 9/17 매입임대 6공고 QnA 결과어 문항 신규 + 군산 9/18·9/23 `완료(보조 누락)` → `완료`**(🔴 **세대 `extra_note` UPDATE 2 · 자격 `supply_form` UPDATE 2 · 정책 UPDATE 1 · 정책 INSERT 32 · `announcement_analysis` UPDATE 2 · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 0 · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 analysis v9.1 · reverify v4.8을 착수 전에 다시 불러왔다. ① ✅ **항목 1** — `168b82da` `c143c40b…` → `ba77399b…` · `966f4695` `e416a0ce…` → `74ed3dec…`(BEFORE 가드 1행씩 · `recruit_count` 불변). 불변식 7을 군산 그룹 7 ID 전체로 걸어 0. ② ✅ **항목 2** — `c999a026` → 「2순위」 `2611c18c…` · `c8221e1b` → 「3순위」 `27674103…`. ③ ✅ **항목 3** — `324608dd` 첫 줄만 청년 p.9 (접속방법) 두 문장 전체로(광주 `…0773` hwpx 바이트 · 충북 PDF 인쇄 p.9 정규화 일치) `26de0db4…` → `b792abd5…`. 다른 두 줄 불변 · 같은 공고 안에서 (접속방법)·「일부 기기에서 서류제출이 불가할 수 있으니」가 든 행은 이 행 하나(B39 온라인 행 `b37fc3e4`와 중복 0). ④ ✅ **항목 4** — 충북 QnA hwpx 바이트 · 광주 QnA PDF 정규화 대조(질문 7개는 문항 번호 레이블이 질문 둘째 줄 앞에 끼어 있어 조각 대조로 통과 · 사이 문자열 = 번호). 행 = 질문 한 줄 + 「ㅇ」 답변 문단(표 「<진행상태 별 청약 신청 가능여부>」는 싣지 않음). category는 기존 QnA 행과 같은 주제 제목 꼴. 청년 Ⅰ-5·Ⅰ-6·Ⅰ-15·Ⅲ-1 · 신혼Ⅰ Ⅰ-7·Ⅰ-8·Ⅰ-10·Ⅱ-6·Ⅱ-8·Ⅲ-1 · 신혼Ⅱ Ⅰ-7·Ⅰ-8·Ⅰ-12·Ⅱ-6·Ⅱ-8·Ⅲ-1 = 공고마다 4·6·6, 형제 16쌍 md5 전부 같음. **Ⅳ-6(신혼Ⅰ·Ⅱ)은 넣지 않음** — 결과어가 질문(「재계약 불가능하나요?」)에만 있고 답은 「재계약 가능합니다」. 기존 행과 문장 겹침 0(양성 대조 통과). 정책 행 29·31·32·31·31·30 → **33·37·38·37·35·36**. ⑤ ✅ **항목 5** — `…020801`·`…020822` 「완료」 · `…020801` `pending_fields` 낡은 세 줄 → 「보조 자료 없음 — 다운님 확인 2026-09-26」 한 줄 · `…020822`는 끝에 그 줄 추가. ⑥ ✅ **검증** — 7개 그룹 스냅샷(블록·그룹 ID·세대·자격·기존 정책·extras·analysis 행 md5, 대상 행 제외) 착수와 같음 · 불변식 1·6·9·10 = 0 · 7(군산 그룹) = 0 · 5 두 공고 true/false · NFC 위반 0 · 🅑 분석률 **76/41 · 7/1 불변**(04:15:12Z → 04:17:45Z · 두 공고 모두 이미 완료 계열) |
