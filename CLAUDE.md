...
| 날짜 | 내용 |
|---|---|
| 2026-09-26 | **B47 — 9/15·9/10·9/7 공고 수도권·충남·경남 5공고 분석·반영(의정부송산3 공임50년 `…0670` · 천안병천신한 국민임대 `…0714` · 홍성남장2 국민임대 `…0729` · 김해진영6 국민임대 `…0716` · [정정] 남양주마석2단지 국민임대 `…0710`) + 0-A B43~B45 `완료(보조 누락)` 7공고 보조 자료 연결**(🔴 **세대 INSERT 11(1·3·1·3·3) · 자격 INSERT 5(1·1·1·1·1) · 정책 INSERT 140(31·28·29·28·24) · `announcement_extras` INSERT 21(0-A 20 · 김해 평면도 1) · `announcement_analysis` INSERT 5(전부 `완료(보조 누락)`) · UPDATE 7(0-A — `완료` 6 · 전주·완주 `…0733` `완료(보조 누락)` 유지 1) · `announcements` UPDATE 0 · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 0(업로드는 착수 전 완료분) · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 analysis v9.1 · reverify v4.8을 착수 전에, analysis를 압축 뒤 첫 DB 쓰기(김해) 전에 다시 불러왔다. ⓪ ✅ **0-A** — 다운님 업로드분을 세대 행이 사는 ID에 이었다: 천안쌍용5-2 `…0756` 3(배치도·위치도 photo · 평면도 39A·39B floorplan `unit_key` 천안쌍용5-2::39) · 부산만덕5 `0000061163` photo 4 · 강서염창 `…0807` 팸플릿 1 · 동탄 `0000061177` 블록 팸플릿 PDF 5개 → 8블록 각 1행 · 전주효자5 블록 4(36A 평면도는 이번 모집 주택형 밖이라 뺌 · 나머지 7블록 미확인이라 `완료(보조 누락)` 유지) · 경남·경기북부 매입 `…0706`·`…0713`은 「보조 자료 없음」 다운님 확인으로 `완료` · 🅑 76/50 → 76/50(12:37:59Z → 12:44:27Z · 이미 완료 계열이라 분자 불변). ① ✅ **의정부 `…0670`** — 49형 25호 · 증액 6.0% · 감액 3.5% · 계약금 20% · 정책 31. ② ✅ **천안 `…0714`** — 38·42·49형 30·10·1 = 41 · 전환 3/3 · ⚠️ 4행(서류제출대상자 발표 시각 14:00↔00시 · 서류제출 방법 · 편의시설 문의처 000-000-0000 · 계약기간 2026.00.00) · 「담당자확인 (예시)」 문단은 `pending_fields`만. ③ ✅ **홍성 `…0729`** — 59형 40호 · 전환 1/1 · ⚠️ 4행(발표 시각 · 서류제출 방법 · 등기우편 접수 기준 3곳 도착분↔소인 · 배점 ③ 2006.09.16). ④ ✅ **김해 `…0716`** — 26·33·46형 200·200·120 = 520(표 머리 총계 없음) · 전환 3/3 · ⚠️ 4행(발표 시각 16:00↔00시 · 서류제출 방법 · 배점 ③ 2007.05.16 · 배점 ④ 2019.05.16∼2026.05.15 — 공고일 9/15와 안 맞는 5월 기준 날짜) · 평면도 PDF 1행(세 주택형 한 파일이라 `unit_key` NULL). ⑤ ✅ **남양주 `…0710`** — 원공고 `…0668`↔정정본 diff 4칸(51B·59 최대전환 3칸 · 배점 ③ 2007.03.17→2007.09.08), `revision_note`는 마지막 1칸만 → 정정본 기준 · 51A·51B·59형 30·20·20 = 70 = 표 머리 (70) · ⚠️ 1행(서류제출 방법). ⑥ ✅ **이번 달 국민임대 패턴 대조** — 증액 7.0% 0곳(5공고 전 행 6.0%) · 서류제출 방법 모순 4공고(천안·홍성·김해·남양주) · 주거약자 배점표 5공고 모두 없음(칸 밀림 대상 0) · 표 머리 직전 회차 총계 0곳. ⑦ ✅ **검증** — 공고마다 한 호출(두 DO 블록) 안에 세대·자격·정책·이미지 md5 봉합 + 불변식 1·2·3·4·5·6·7·9·10·NFC · 형제·다른 회차 레코드 산물 0 불변(13:30Z) · 🅑 접수 전 **76/50 → 76/55**(12:56:29Z → 13:30:34Z · 분자 +5 = 닫은 공고 5) · 접수 중 7/1 불변 |
| 2026-09-26 | **B46 — 공고 카드 정책 안내를 「이번 회차」와 「다른 회차」로 가름 · 세대·블록 「지난 회차」 → 「다른 회차」**(🔴 **코드 1(`index.html`) · `sw.js` CACHE_NAME v142 → v143 · DB 0 · RPC 0 · EF 0 · Notion 0** · `[zipfit-backup]` 접촉 0). ① ✅ **조사** — 정책 행을 그리는 자리는 `loadAnnouncementPolicies` 하나뿐(특이사항 칸은 `announcements.special_notes`, 공급일정은 카드 data 속성이라 정책 행을 읽지 않는다). 카드는 대표 `apply_end`(data-apply-end)를 이미 들고 있었고, 행의 출처 공고 `apply_end`·`apply_start`는 기존 `fetchGroupRounds`(같은 `announcements` REST 조회)의 select에 두 칸을 더해 받는다(RPC 변경 0). ② ✅ **사양 축 = `apply_end`** — 기존 세대 회차 축(`zfNoticeDate`)과는 활성 104카드·666구성원 중 1곳만 갈린다: 태백철암1(LH 09-11 · MYHOME 09-14, 마감 둘 다 10-28) — `apply_end` 축이 같은 회차로 맞게 본다. 세대 분할 축은 그대로 두었다(카드 1층 요약 RPC와 같은 규칙). ③ ✅ **정책 안내** — 기본 목록은 이번 회차 행만 · 다른 회차는 「🕘 다른 회차 안내 (N)」 접힘(기본 닫힘) 안에 회차별 소제목(공고일 · 접수기간 — 같은 회차 구성원 중 가장 이른 값, 모르면 채우지 않음) · 중복 제거는 이번 회차 쪽 먼저 · 갈리면 배너 「이 단지의 다른 회차 공고 안내는 …」, 다른 회차 행이 없으면 배너 없음 · orphan(이번 회차 0 · 다른 회차만)과 판정 재료 없음은 종전 경로 그대로(활성 orphan 0장). ④ ✅ **표기** — 세대 배지·접힘 제목·세대 제목·배너 2문구·변동 요약 머리·블록 배지의 「지난 회차」 → 「다른 회차」(클래스명 불변). 목록 1층 칩 「지난 회차(날짜) 기준」(RPC `round_state`, 추천 탭에도 뜸)은 다른 화면에 번져 손대지 않음. ⑤ ✅ **검증** — 배포 코드 그대로 Chromium에 올리고 Supabase 응답만 대역(정책 본문은 md5 + 일정 표식, DB canonical md5와 봉합: 군산 정책 `958d4a70…` · 회차 `8c6249e2…`, 강서 `317854eb…` · `cda49bea…`): 군산 9/18 기본 21(‘26.10.06 행 0) · 접힘 18(9/23 16 · 7월 2) / 9/23 기본 29(‘26.09.29 행 0) · 접힘 10(9/18 8 · 7월 2) / 강서 70 · 접힘·배너 없음(종전과 같음). 활성 기준 갈리는 카드 10장 · 103행 · 배너가 없어지는 카드 2장(태백 `21199_1` · 칠곡왜관4 `…0810`) |
| 2026-09-26 | **B45 — 0-A 강서염창 PUA 번호 기호 → ①②③ · 0-B 동탄 Ⅶ-1/Ⅶ-2 ⚠️ 1행 · 9/15 국민임대 3공고 분석·반영(전주·완주 `2015122300020733` 블록 8 · 울산 `2015122300020745` 블록 10 · 춘천·홍천 정정 `2015122300020779` 블록 10)**(🔴 **세대 INSERT 37(14·12·11) · 자격 INSERT 29(8·11·10) · 정책 INSERT 81(28·28·24 + 동탄 ⚠️ 1) · 정책 UPDATE 3(강서 0-A) · `announcement_analysis` INSERT 3(전부 `완료(보조 누락)`) · UPDATE 1(강서 `pending_fields` 1줄 추가) · `announcements` UPDATE 0 · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 0(업로드는 착수 전 완료분) · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 analysis v9.1 · reverify v4.8을 착수 전에, analysis를 압축 뒤 첫 DB 쓰기(춘천) 전에 다시 불러왔다. ① ✅ **0-A** — 강서 `…020807` 정책 3행(`3318d0ee` `45d07ebf…`→`6b092958…` · `c11b23fc` `1d9bea8a…`→`fffe4efd…` · `613e35a5` `584b9ac1…`→`cd8ad266…`)의 U+F02B1·F02B2·F02B3을 PDF 쪽 이미지대로 ①·②·③으로(BEFORE 가드 · 다른 글자 불변) · PUA 전역 잔존 정책 0 · 세대 `extra_note` 0 · 자격 0. ② ✅ **0-B** — 기준점(계약체결기간 내 미체결)·대상(당첨자) 같음 · 제도(주택공급규칙 제57조)가 당첨자 관리와 계약포기를 따로 다룬다 → 성립, 동탄 `0000061177`에 `⚠️ 계약체결기간 내 미체결 시 처리` 1행(정책 38→39). ③ ✅ **전주·완주** — 합 512 · 전환 증액 역산: 완주삼례2 36·46형 7.0%, 전북혁신9·10·전주반월2는 다른 월임대료 기준과 맞아 ⚠️ 2행 + ⚠️ 서류제출 방법 · ⚠️ 인터넷 신청 가능 시간 · 모집표 머리 (170)≠행 합 162(직전 회차 총계)는 `pending_fields`만. ④ ✅ **울산** — 합 300 · 증액 7.0% 6행 ⚠️ · 서류제출 방법 3곳 ⚠️ · 발표 시각 3곳 ⚠️ · 방어 50㎡ 미만/이상 자격 2행(형제 선례). ⑤ ✅ **춘천·홍천** — 원공고 `…0741`↔정정본 diff 8곳(건설호수 표기 2 · 우두1 최초입주 · 구조/난방 4 · 우두3 셀 병합), `revision_note`는 2곳만 → 정정본 기준 · 전환 11/11(6.0%·3.5%·계약금 5%) · ⚠️ 0 · 「주거약자」 검색 0회 · 서류양식.zip hwp 6종은 빈 양식 · 원공고 `…0741` 산물 0. ⑥ ✅ **검증** — 공고마다 봉합 블록 3개(세대·자격·정책 md5 DB = 로컬) · 불변식 1·2·3(블록별·합)·4·5·6·7·9·10·NFC · 형제 23공고 스냅샷 착수(07:38Z)와 같음 · 강서 정책 70 · 7/15 춘천 회차 불변 · 🅑 접수 전 **76/47 → 76/50**(07:35:17Z → 08:19:19Z · 분자 +3 = 닫은 공고 3) · 접수 중 7/1 불변 |
