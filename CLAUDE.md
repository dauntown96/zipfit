...
| 날짜 | 내용 |
|---|---|
| 2026-09-26 | **B48 — 0-A B45 세 공고 보조 자료 연결(전주·완주 `…0733` · 울산 `…0745` · 춘천·홍천 `…0779`) + 9/30 접수 다블록 2공고 분석·반영(목포·무안·영암·완도 국민임대 `…0734` 블록 6 · 부산 영구임대 `…0818` 블록 5)**(🔴 **`announcement_extras` INSERT 74(0-A 26·25·23) · `announcement_analysis` UPDATE 3(0-A `pending_fields` 낡은 줄 md5 가드 교체 — 세 공고 모두 `완료(보조 누락)` 유지) · 세대 INSERT 26(12·14) · 자격 INSERT 37(7·30) · 정책 INSERT 60(30·30) · `announcement_analysis` INSERT 2(둘 다 `완료(보조 누락)`) · `announcements` UPDATE 0 · DELETE 0 · DDL 0 · 함수 0 · EF 0 · 코드 0(`index.html`·`sw.js` 불변) · Drive 0 · Notion 0** · `[zipfit-backup]` 접촉 0). 스킬 analysis v9.1 · reverify v4.8을 착수 전에, analysis를 압축 뒤 첫 DB 쓰기(부산) 전에 다시 불러왔다. ⓪ ✅ **0-A** — 폴더 새 파일을 `nextPageToken` 끝까지 받아 파일명·OCR로 블록·주택형에 이었다(평면도 `unit_key` 30 · 이번 회차 모집 주택형 밖 평면도 15개는 붙이지 않음 · BMP 파일 포함) · 빈 블록: 완주삼례2 · 울산화봉2 · 울산그린카운티 · 춘천퇴계7 · 홍천신아1(평면도 없는 블록: 울산매곡·방어·웅촌) · 🅑 76/55 → 76/55(13:38:46Z → 13:47:59Z · 이미 완료 계열이라 분자 불변). ① ✅ **목포 `…0734`** — 6블록 272호(표 머리 총계 없음) · 전환 10/10(6.0%·3.5%) · 증액 7.0% 0곳 · ⚠️ 5행(서류제출 방법 4곳 · 서류제출대상자 발표 시각 16:00↔14시 · 후순위 접수여부 게시처 · 인터넷 신청 가능 시간 · 배점 ③ 2007.03.24 — ④는 날짜 없음) · 주거약자 배점표 없음 · 같은 LH 첨부의 영암용앙1(`21261_7`, 별도 공고)은 범위 밖이라 미분석. ② ✅ **부산 `…0818`** — 5블록 520호 = MYHOME 블록 합 · 가군/나군 임대조건 두 세트를 청주·김천 영구임대 선례대로 형마다 `supply_target` 두 행 · 전환 열 없음(「재료 없음」) · 자격 6갈래(1순위 가·다·라·사 검증 생략 / 나·마·바·아 70% / 자 · 2순위 차 50% / 카 / 타 100%) × 5블록 · ⚠️ 0 · hwpx U+F0A0 2곳을 PDF p.16 이미지대로 「·」로. ③ ✅ **검증** — 공고마다 한 호출(두 DO 블록) 안에 세대·자격·정책 md5 봉합 + 불변식 1·2·3(블록별·합)·4·5·6·7·9·10·NFC · 형제 스냅샷 불변 · 🅑 접수 전 **76/55 → 76/57**(13:47:59Z → 14:17:34Z · 분자 +2 = 닫은 공고 2) · 접수 중 7/1 불변 |
